...
// console.log("params in word detail page",params);
  ...
  const resolvedParams =
    ...
    console.log("resolvedParams in word detail page",resolvedParams);
  ...
  async function upsertReaction(
    ...
    const payload = {
      ...
      comments_text: next.is_like ? "liked" : next.is_dislike ? "disliked" : "cleared",
    };
  ...
  async function handleReactionClick(definitionId: number, kind: "like" | "dislike") {
    ...
    const next: UserReaction = togglingOff
      ? {
